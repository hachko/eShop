...
public class CreationCommandeForm {
	...
	private static final String CHAMP_CHOIX_CLIENT     = "saisieClient";
    private static final String CHAMP_LISTE_CLIENTS    = "nomClientExistant";
    ...
    private static final String ANCIEN_CLIENT          = "existant";
    private static final String SESSION_CLIENTS        = "clients";
    private static final String FORMAT_DATE            = "dd/MM/yyyy HH:mm:ss";
    
    private static final String ATT_FORM_CLIENT 	   = "formClient";
    ...
    public Commande creerCommande( HttpServletRequest request, String chemin ) {
        ...
        if ( ANCIEN_CLIENT.equals( choixNouveauClient ) ) {
            ...
            //affectation des données du formulaire client à la requête
            request.setAttribute(ATT_FORM_CLIENT, clientForm);

            /*
             *récupération de la map d'erreurs du client
             */
